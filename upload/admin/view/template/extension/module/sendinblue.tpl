      ...
      <div class="container-fluid">
         <div class="form-group">
            <div class="col-sm-12">
               <img src="../admin/view/image/sendinbluelogo.png" atl="" title="" class="sibocs" />
               <br>
               <p><b>Module version:</b> v<?php echo $version; ?></p>
               <hr>
               ...
               <h5><strong>Opensource Project</strong></h5>
               <p><b>Website:</b> <a href="https://github.com/ILDaviz/Sendinblue-Opencart-V2.X-V3.X">github.com</a></p>
