...
class ControllerExtensionModuleSendinBlue extends Controller {
	...
	public function index() {
		...
		//$this->printr($data['attributes']);

		//exit($data['tracking_id']);
		...
		//exit('<pre>'.print_r($settings,1) . '</pre>');
